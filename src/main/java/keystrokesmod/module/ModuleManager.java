...
import keystrokesmod.module.impl.hypixelpit.*;
...
public class ModuleManager {
    ...
    public static SpadeSwapper spadeSwapper;
    ...
    public void register() {
        ...
        // hypixelpit
        this.addModule(spadeSwapper = new SpadeSwapper());
    ...
    private static double getWidth(@NotNull Module module) {
        return HUD.getFontRenderer().width(
                module.getPrettyName()
                        + ((HUD.showInfo.isToggled() && !module.getPrettyInfo().isEmpty())
                                ? " " + module.getPrettyInfo()
                                : ""));
    }
